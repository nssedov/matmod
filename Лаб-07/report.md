...
subtitle: "Модель распространения рекламы - вариант 17"
...
3.	$\frac{dn}{dt} = (0.65\sin{7t} + \cos{3t} n(t))(N-n(t))$

При этом объем аудитории $N = 741$, в начальный момент о товаре знает 4 человек.
