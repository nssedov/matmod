...
subtitle: "Модель хищник-жертва - вариант 17"
...
$$
 \begin{cases}
	\frac{dx}{dt} = -0.69x(t) + 0.068y(t)x(t)
	\\   
	\frac{dy}{dt} = 0.67y(t) - 0.066y(t)x(t)
 \end{cases}
$$

Постройте график зависимости численности хищников от численности жертв, а также графики изменения численности хищников и численности жертв 
при следующих начальных условиях: $x_0=4, y_0=11$
...
Стационарное состояние $x_0=\frac{a}{b}=10.147, y_0=\frac{c}{d}=10.152$
