...
subtitle: "Модель гармонических колебаний - вариант 17"
...
силы $\ddot{x}+11\dot{x}+2x=0$
3. Колебания гармонического осциллятора c затуханием и под действием внешней
силы $\ddot{x}+2\dot{x}+2x=2\cos{2t}$

На итнтервале $t \in [ 0;51 ]$, шаг 0.05, $x_0=0.5, y_0=1$
